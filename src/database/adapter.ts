...
export interface DatabaseAdapter {
  ...
  logMessage(chatId: string, sender: 'user' | 'agent', text: string, opts?: { entryId?: string; msg_id?: string; userId?: string; weight?: number; tokensUsed?: number; bookIds?: string[] }): Promise<Message | null>;
